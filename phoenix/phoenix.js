 ...
 */
var GRID_A_RATIO, GRID_B_RATIO, GRID_HEIGHT, GRID_RATIO, GRID_WIDTH, MARGIN, ctrl, ctrlAlt, ctrlAltCmd, ctrlCmd, ctrlShift, debug, key_binding, lastFrames;
...
Window.prototype.topLeft = function() {
  var frame;
  frame = this.frame();
  return {
    x: frame.x,
...
key_binding('enter', ctrlAltCmd, function() {
