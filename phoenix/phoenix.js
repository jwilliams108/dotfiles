 ...
 */
var GRID_A_RATIO, GRID_B_RATIO, GRID_HEIGHT, GRID_RATIO, GRID_WIDTH, MARGIN, ctrlAlt, ctrlAltCmd, debug, key_binding, lastFrames;
...
Window.prototype.toggleFibScreen = function() {
  var fullFrame, grid_height, grid_width, grid_x, grid_y;
  ...
  fullFrame = this.calculateGrid(grid_x / GRID_WIDTH, grid_y / GRID_HEIGHT, grid_width / GRID_WIDTH, grid_height / GRID_HEIGHT);
  if (!_.isEqual(this.frame(), fullFrame)) {
    this.rememberFrame();
    return this.toGrid(grid_x / GRID_WIDTH, grid_y / GRID_HEIGHT, grid_width / GRID_WIDTH, grid_height / GRID_HEIGHT);
...
key_binding('D', ctrlAltCmd, function() {
  return Window.focusedWindow().toggleFibScreen();
});
...
key_binding('L', ctrlAlt, function() {
  return Window.focusedWindow().focusWindowRight();
});

key_binding('K', ctrlAlt, function() {
  return Window.focusedWindow().focusWindowUp();
});

key_binding('J', ctrlAlt, function() {
