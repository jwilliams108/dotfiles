...
[_BL] = KEYMAP_ANSI(
 ...
 LSFT_PN,          KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,  KC_COMM, KC_DOT,KC_SLSH, RSFT_PN,   KC_UP,KC_PGDN, \
   HYPER, KC_LALT, LGUI_BR,                KC_SPC,                        RGUI_BR,MO(_FL),KC_RCTRL,KC_LEFT, KC_DOWN,KC_RGHT),
...
[_FL] = KEYMAP_ANSI(
  ...
  _______,KC_MRWD,KC_MPLY,KC_MFFD,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,KC_HOME, \
